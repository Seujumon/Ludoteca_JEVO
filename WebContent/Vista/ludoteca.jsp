...
<body>
  ...
  <div class="container-fluid">
	...
	<div class="d-flex flex-row justify-content-center align.items-center py-4">
		<h2 class="d-flex">Ludoteca</h2>
		<!-- Botón para ver la ludoteca completa -->
		</div>
		<div class="d-flex flex-row justify-content-center align.items-center py-4">
		<a class="btn btn-secondary" href="JuegoController?accion=full">
		<button type="button" class="btn btn-secondary d-flex" >Completa</button></a>
	</div>
	<!--Tabla-->
	<div class="px-5">
